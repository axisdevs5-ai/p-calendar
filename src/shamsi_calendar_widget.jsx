...
export default function ShamsiCalendarWidget() {
  ...
  const mainCardClasses = `grid grid-cols-1 md:grid-cols-2 gap-0 rounded-[32px] overflow-hidden shadow-2xl relative transition-all duration-300 w-full max-w-2xl ${glassTheme ? 'backdrop-blur-2xl bg-black/30 border border-white/10 text-neutral-100' : lightBg ? 'bg-white text-neutral-900' : 'bg-neutral-900 text-neutral-200'}`;
